...
class AttentionWordRNN(BaseModel):

    def __init__(self, Y, embed_file, dicts, lmbda, gpu, batch_size, num_tokens, dropout, embed_size, word_gru_hidden, bidirectional= True):        
...
class AttentionSentRNN(BaseModel):
    
    
    def __init__(self, Y, embed_file, dicts, lmbda, gpu, batch_size, dropout, sent_gru_hidden, word_gru_hidden, n_classes, bidirectional= True):        
