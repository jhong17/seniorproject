...
def pick_model(args, dicts):
    ...
    if args.model == "rnn":
        ...
        model = models.HierarchicalRNN(Y, args.embed_file, dicts, args.lmbda, args.gpu, num_tokens=len(dicts['ind2w']), n_classes=Y, dropout=args.dropout, embed_size=args.embed_size, word_gru_hidden=100, sent_gru_hidden=100, batch_size=args.batch_size, bidirectional=True)
